...
class IgCfatMSEModel(SRModel):
    """MSE-based IG_CFAT Model.
    ...
    def __init__(self, opt):
        super(IgCfatMSEModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(IgCfatMSEModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
